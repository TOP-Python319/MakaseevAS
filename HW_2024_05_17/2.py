class PermissionMixin: # а миксин ли это? выглядит как полноценный родитель
    ...
    def has_permission(self, permission):
        return True if permission in self.permissions else False # или return permission in self.permissions
